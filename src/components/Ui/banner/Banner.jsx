          ...
          <div className="row">
            <div className="col-lg-8">
              <h1 className="bold white" style={{ fontSize: "34px" }}>
                User expereince Design (UX)
              </h1>
              <h1 className="bold white" style={{ fontSize: "34px" }}>
                User Interface Design (UI)
              </h1>
              <p className="lead  font-14 opacity mt-5 opacity">
                This is your path to a career in UI/UX. In this program, you'll
                learn in-demand skills <br /> that will have you job-ready in
                less than 6 months. No degree or experience required.
              </p>
